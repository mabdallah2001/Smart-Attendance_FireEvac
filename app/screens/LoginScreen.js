...
const LoginScreen = ({navigation}) => {
    ...
    return (
        <KeyboardAvoidingView behavior="padding" style={styles.container}>
            ...
            <Input placeholder="Email" autoFocus type="email" autoCorrect={false} autoCapitalize='none' keyboardType="email-address" value={email} onChangeText={(text) => setEmail(text)} />
